...
using Exercism.zipper;

public class ZipperTest
{
    private static BinTree<int> bt(int v, BinTree<int> l, BinTree<int> r) { return new BinTree<int>(v, l, r);}
	private static BinTree<int> leaf(int v) { return bt(v, null, null); }

    private static readonly BinTree<int> empty = null;
    private static BinTree<int> t1 = new BinTree<int>(1, bt(2, empty, leaf(3)), leaf(4));
    private static BinTree<int> t2 = new BinTree<int>(1, bt(5, empty, leaf(3)), leaf(4));
    private static BinTree<int> t3 = new BinTree<int>(1, bt(2, leaf(5), leaf(3)), leaf(4));
    private static BinTree<int> t4 = new BinTree<int>(1, leaf(2), leaf(4));
