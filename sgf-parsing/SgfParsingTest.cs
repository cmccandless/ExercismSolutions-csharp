...
public class SgfParsingTest
{
	...
	private static SgfTree TreeWithChildren(IDictionary<string, string[]> data, SgfTree[] children) { return new SgfTree(data, children); }
	private static SgfTree TreeWithSingleChild(IDictionary<string, string[]> data, SgfTree child) { return new SgfTree(data, child); }
	private static SgfTree TreeWithNoChildren(IDictionary<string, string[]> data) { return new SgfTree(data); }

	private static IDictionary<string, string[]> CreateData(string key, params string[] values) { return new Dictionary<string, string[]> { { key, values }}; }
